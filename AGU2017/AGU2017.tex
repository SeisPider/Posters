...
\includegraphics[width=\textwidth]{./images/XJ.pdf}
\end{minipage}
\hspace{0.1cm}
\end{center}
...
\putfigureLR{0.45\textwidth}{./images/Pathnum.png}{0.45\textwidth}{./images/JointDisp.pdf}
\hspace{0.15cm}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{./images/resolution.pdf}
...
\node (a) at (-0.75,-0.2) {\includegraphics[width=0.33\textwidth]{./images/Tarim.png}};
\node (b) at (4.2,-0.2) {\includegraphics[width=0.33\textwidth]{./images/tianshan.png}};
\node (c) at (9.0,-0.2) {\includegraphics[width=0.33\textwidth]{./images/Junggar.png}};
\node at (-3.05, 3.2) {(a)};
\node at (1.9, 3.2) {(b)};
\node at (6.7, 3.2) {(c)};
\end{tikzpicture}
